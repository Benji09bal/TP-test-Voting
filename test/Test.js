...
contract('Voting', accounts => {
    ...
    describe('Workflow 3 Add proposals', function () {
        ...
        it('Add Proposals', async function() {
            ...
            const receipt3 = await votingInstance.addProposal('Proposal 1', {from: addr1});
            expectEvent(receipt3, 'ProposalRegistered', { proposalId: '1' });
            const receipt4 = await votingInstance.addProposal('Proposal 2', {from: addr2});
    ...
    describe('Workflow 8 tallyVotes', function () {
        ...
        it('tallyVotes', async function() {
            ...
            expectEvent(receipt7, 'WorkflowStatusChange', { previousStatus: '4', newStatus: '5' });
